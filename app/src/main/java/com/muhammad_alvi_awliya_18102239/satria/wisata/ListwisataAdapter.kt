...
class ListwisataAdapter (var results: ArrayList<ListwisataModel>, private val listener: OnAdapterListener):
    RecyclerView.Adapter<ListwisataAdapter.ViewHolder>(), Filterable {

    var tableList: MutableList<ListwisataModel> = mutableListOf()
    ...
    fun setData(data: MutableList<ListwisataModel>){
        tableList = data.toMutableList() // makes a copy
        results = data as ArrayList<ListwisataModel>
    ...
    interface OnAdapterListener {
        fun onClick(result: ListwisataModel)
    }
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun publishResults(charSequence: CharSequence?, filterResults: FilterResults) {
                results = filterResults.values as ArrayList<ListwisataModel>
                notifyDataSetChanged()
            }
        }
    }
